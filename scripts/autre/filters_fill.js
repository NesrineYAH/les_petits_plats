...
function fillFilters(recipes) {
  ...
  tagIngredientAlreadyAdded = fase;
  // eslint-disable-next-line no-undef
  ...
  // eslint-disable-next-line no-undef
  tagUstensilsAlreadyAdded = false;
  // eslint-disable-next-line no-undef
...
function isArrowClicked() {
  ...
  const arrowDownAppliances = document.querySelector(
  ...
  /* Appliance */
  arrowDownAppliances.addEventListener("click", () => {
